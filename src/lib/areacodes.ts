/**
 * North American area code (NPA) -> US state full name.
 *
 * Cloudflare's `request.cf.region` returns the full subdivision name (e.g.
 * "California"), so we map to full names for direct comparison in match.ts.
 *
 * This is a SOFT signal: number portability and mobile usage mean an area code
 * does not reliably indicate current location. It only nudges the match score.
 * Not exhaustive — unknown codes return "" (treated as unknown geo). Extend as
 * needed.
 */
export const AREA_CODE_STATE: Record<string, string> = {
  ...
  "760": "California", "805": "California", "818": "California", "820": "California",
  ...
  "701": "North Dakota",
  // Ohio
  "216": "Ohio", "220": "Ohio", "234": "Ohio", "330": "Ohio", "380": "Ohio", "419": "Ohio",
  "440": "Ohio", "513": "Ohio", "567": "Ohio", "614": "Ohio", "740": "Ohio", "937": "Ohio",
  // Oklahoma
